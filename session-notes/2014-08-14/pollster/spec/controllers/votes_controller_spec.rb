  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved vote as @vote" do
        post :create, {:vote => invalid_attributes}, valid_session
        expect(assigns(:vote)).to be_a_new(Vote)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested vote" do
        vote = Vote.create! valid_attributes
        put :update, {:id => vote.to_param, :vote => new_attributes}, valid_session
        vote.reload
    ...
    describe "with invalid params" do
      it "assigns the vote as @vote" do
        vote = Vote.create! valid_attributes
        put :update, {:id => vote.to_param, :vote => invalid_attributes}, valid_session
        expect(assigns(:vote)).to eq(vote)
      end
